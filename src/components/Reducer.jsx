...
function reducer(state, action) {
    switch (action.type) {
        case 'INCREMENT_R':
            return Object.assign({}, state, {r: limitRGB(state.r + action.payload)})
        case "DECREMENT_R":
            return Object.assign({}, state, {r: limitRGB(state.r - action.payload)})
        
        case 'INCREMENT_G':
            return Object.assign({}, state, {g: limitRGB(state.g + action.payload)})
        case "DECREMENT_G":
            return Object.assign({}, state, {g: limitRGB(state.g - action.payload)}) 
            
         case 'INCREMENT_B':
            return Object.assign({}, state, {b: limitRGB(state.b + action.payload)})
         case "DECREMENT_B":
            return Object.assign({}, state, {b: limitRGB(state.b - action.payload)})
